...
Player = game.Class.extend({
    ...
    init: function() {
        ...
        var shape = new game.Rectangle(48, 48);
        ...
        this.flyEmitter.position.x = this.sprite.position.x + 10;
        this.flyEmitter.position.y = this.sprite.position.y - 10;
        this.flyEmitter.emit(3);
    ...
    update: function() {
        ...
        this.smokeEmitter.position.x = this.sprite.position.x - 50;
        this.smokeEmitter.position.y = this.sprite.position.y;

        this.flyEmitter.target.x = this.sprite.position.x - 150;
        this.flyEmitter.target.y = this.sprite.position.y - 0;
    },
