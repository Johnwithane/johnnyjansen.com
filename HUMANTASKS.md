...
- [ ] **Set the params.** Locally: copy `functions/.env.example` to `functions/.env` (just `TIMEZONE`). There is no owner email any more: the first person to sign in and found a household is the first adult.
